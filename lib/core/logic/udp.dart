...
class UdpReceiver {
  ...
  StreamController<SensingMessage> _messageController = StreamController<SensingMessage>.broadcast();
      ...
      if (event == RawSocketEvent.read) {
        ...
        if (datagram != null) {
          ...
          try {
            ...
            final receivedCrc = ByteData.sublistView(crcBytes).getUint32(0, Endian.little);
            final calculatedCrc = getCrc32(payload);

            if (receivedCrc != calculatedCrc) {
              print('CRC mismatch: expected $receivedCrc but got $calculatedCrc');
              return;
            }
